...
public class CodeGenerator extends com.lhl.xxxcloud.generator.core.Constant {
    ...
    public static PackageConfig packageConfig() {
        ...
        return new PackageConfig()
                ...
                .setParent(organization)//父包名（组织com.lhl）
    ...
    public static InjectionConfig injectionConfig(final String entityName) {
        ...
        focList.add(new FileOutConfig("/templates/MyResult.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return outPutDir + "/"+organization.replace(".","/")+"/"+moduleName+"/core/Result" + StringPool.DOT_JAVA;
            }
        });
