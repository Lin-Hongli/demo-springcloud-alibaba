...
//            InputStream in = Main.class.getClassLoader().getResourceAsStream("D:\\IdeaProjects\\generatorApp\\");
            ...
            properties.load(in);
            localhost.setText(StringUtils.isEmpty(properties.getProperty("location"))? com.lhl.xxxcloud.generator.core.Constant.location:properties.getProperty("location"));
            port.setText(StringUtils.isEmpty(properties.getProperty("port"))? com.lhl.xxxcloud.generator.core.Constant.port:properties.getProperty("port"));
            dataBase.setText(properties.getProperty("dataBase"));
            table.setText(properties.getProperty("table"));
            userName.setText(StringUtils.isEmpty(properties.getProperty("userName"))? com.lhl.xxxcloud.generator.core.Constant.userName:properties.getProperty("userName"));
            password.setText(StringUtils.isEmpty(properties.getProperty("password"))? com.lhl.xxxcloud.generator.core.Constant.password:properties.getProperty("password"));
            ...
            author.setText(StringUtils.isEmpty(properties.getProperty("author"))? com.lhl.xxxcloud.generator.core.Constant.author:properties.getProperty("author"));
            in.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
